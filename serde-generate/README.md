...
* TypeScript 4 (packaged and tested with Deno) [(follow-up issue)](https://github.com/diem/serde-reflection-diem/issues/119)
* Dart >= 2 [(follow-up issue)](https://github.com/diem/serde-reflection-diem/issues/120)
